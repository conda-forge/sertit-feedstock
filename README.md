...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sertit-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12621&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sertit-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sertit` can be installed with:

```
conda install sertit
```

It is possible to list all of the versions of `sertit` available on your platform with:
